...
int main()
{
    ...
    //cerr << "Before the original function" << endl;
...
{
  cerr << "Starting to remove keplers" << endl; 
    ...
    planets.print(outfile);
    outfile.close();
    //cerr << "End of remove keplers fxn" << endl; 
    return 1;
}
...
{
  //cerr << "Beginning of original order" << endl; 
    ...
    //cerr << "End of original order" << endl; 
    return SUCCESS;
}
